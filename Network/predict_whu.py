...
def snapshot_forward(model, dataloader, save_path, num_classes, args):
    ...
    for i in range(num_classes - 1):
        print(i, class_name[i + 1], test_acc_per_class[i], test_IoU[i])


def parse_args():
    parser = argparse.ArgumentParser(description="predict")
    parser.add_argument('--test-data-root', type=str, default=r'/home/wyc/data/whu-opt-sar/crop_256/test/')
    parser.add_argument('--test-batch-size', type=int, default=32, metavar='N',
                        help='batch size for testing (default:16)')
    parser.add_argument('--num_workers', type=int, default=8)

    parser.add_argument("--model-path", type=str,
                        default=r"/home/wyc/Code/SOLC/weights/my/ours_kd/epoch_39_oa_0.75387_kappa_0.66719_latest.pth")
