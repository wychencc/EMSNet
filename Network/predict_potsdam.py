...
def parse_args():
    ...
    parser.add_argument('--test-data-root', type=str, default=r'/home/wyc/data/potsdam/crop_256/test/')
    parser.add_argument('--test-batch-size', type=int, default=16, metavar='N',
                        help='batch size for testing (default:16)')
    parser.add_argument('--num_workers', type=int, default=8)

    parser.add_argument("--model-path", type=str,
                        default=r"/home/wyc/Code/SOLC/weight_potsdam/my/kd_sam_jiegou2_e_d/best.pth")
